...
- [subsquid/squid-sdk](https://github.com/subsquid/squid-sdk) - TypeScript ETL toolkit for indexing Ethereum, Solana, and Substrate data, sourced from SQD Network.
...
- [gofiber/fiber](https://github.com/gofiber/fiber) - ⚡️ Express inspired web framework written in Go
- [latticexyz/mud](https://github.com/latticexyz/mud) - MUD is a framework for building autonomous worlds
- [diptools/dip](https://github.com/diptools/dip) - Rust application framework focuses on composability, ECS and Web3.  Powered by Bevy game engine, Tauri, and Dioxus. From desktop apps to the Metaverse.
...
- [off-grid-ai/mobile](https://github.com/off-grid-ai/mobile) - The Swiss Army Knife of Offline AI. Chat, Speak, and Generate Images - Privacy First, Zero Internet. Download an LLM and use it on your mobile device. No data ever leaves your phone. Supports text-to-
...
- [edmundhung/remix-cloudflare-template](https://github.com/edmundhung/remix-cloudflare-template) - 📜  Remix 3 template for Cloudflare Workers
...
- [casscauley/hive.js](https://github.com/casscauley/hive.js) - 
...
- [franfrandev/solhunt](https://github.com/franfrandev/solhunt) - Hunt for common bad practices in Solidity smart contracts !
...
- [LightDotSo/foundry-simulator](https://github.com/LightDotSo/foundry-simulator) - Simulate txs to human readable format
